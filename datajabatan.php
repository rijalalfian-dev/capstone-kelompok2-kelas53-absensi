...
<head>
    ...
    <title>Data Jabatan - Sistem Informasi Karyawan</title>
            ...
            <div class="container">
                <div class="admin-container">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="datajabatan.php" class="d-block py-2 text-primary"><i class="fas fa-briefcase mr-2"></i> Data Jabatan</a></li>
                        ...
                        <div class="col-md-9">
                            <form class="search-form" action="prospenjab.php" method="POST">
                                <input class="form-control" type="text" name="cari" placeholder="Cari Jabatan" autocomplete="off">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php
                                    $query = "SELECT * FROM tb_jabatan ORDER BY jabatan";
                                    $pola = 'asc';
                                    $pola_baru = 'asc';
                                    ...
                                    if (isset($_GET['orderby']) && isset($_GET['pola'])) {
                                        ...
                                        $pola = $_GET['pola'];
                                        $query = "SELECT * FROM tb_jabatan ORDER BY $orderby $pola";
                                    ...
                                    $data_jabatan = mysqli_query($koneksi, "$query LIMIT $halaman_awal, $batas");
                                    $no = $halaman_awal + 1;
                                    ?>
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th><a href="?orderby=jabatan&pola=<?php echo $pola_baru; ?>">Jabatan</a></th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php while ($d = mysqli_fetch_array($data_jabatan)) { ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo $d['jabatan']; ?></td>
                                                        <td>
                                                            <a href="edit_jabatan.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                                                            <a href="hapus_jabatan.php?id=<?php echo $d['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus data ini?')"><i class="fas fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php $no++; } ?>
                                            </tbody>
